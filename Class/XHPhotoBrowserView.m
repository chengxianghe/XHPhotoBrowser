...
@interface XHPhotoBrowserView() <UIScrollViewDelegate>
@property (nonatomic,strong) XHProgressView *indicatorView;
...
@implementation XHPhotoBrowserView
...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    XHProgressView *indicatorView = [[XHProgressView alloc] init];
    indicatorView.viewMode = self.viewMode;
    indicatorView.indicatorViewItemMargin = self.indicatorViewItemMargin;
